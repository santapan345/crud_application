...
const Edit = () => {
 ...
 useEffect(()=>{
    axios.get(`https://vyu7gqo1j2.execute-api.ap-southeast-2.amazonaws.com/api/getone/${id}`)
    .then((response)=>{
 ...
 const submitForm = async(e)=>{
    e.preventDefault();
    await axios.put(`https://vyu7gqo1j2.execute-api.ap-southeast-2.amazonaws.com/api/update/${id}`, user)
    .then((response)=>{
